...
import weightever.learning.replay_buffer as replay_buffer
import weightever.learning.naviHaul_common_agent as naviHaul_common_agent 
...
class AMPAgent(naviHaul_common_agent.CommonAgent):
    ...
    def play_steps(self):
        ...
        # Log Rewards
        swanlab.log({"Rewards/task_rewards": torch.mean(mb_rewards_task),
