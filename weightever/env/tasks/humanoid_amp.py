...
from weightever.env.tasks.humanoid import Humanoid, dof_to_obs
from weightever.utils import gym_util
from weightever.utils.motion_lib import MotionLib
...
class HumanoidAMP(Humanoid):
    ...
    def _reset_envs(self, env_ids, randomize=True):
        ...
        super()._reset_envs(env_ids, randomize=randomize)
